 ...
 * @author Tom
 */
public final class Home_ND extends javax.swing.JFrame {

    public GraphND graph_nd;
    public Point p; 
     ...
     * @param graph_d
     */
    public Home_ND(GraphND graph_nd) {
      
        initComponents();
        setSize(900, 500);
        setResizable(false);
        setVisible(true);
        this.graph_nd = graph_nd;
        DrawPanel.repaint();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel1.text")); // NOI18N

        BackLabelButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/left-arrow.png"))); // NOI18N
        BackLabelButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.BackLabelButton.text")); // NOI18N
        ...
        jLabel3.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel3.text")); // NOI18N
        ...
        SelectedObjectLabel.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.SelectedObjectLabel.text")); // NOI18N
        ...
        jLabel6.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel6.text")); // NOI18N
        ...
        getAdjNodesButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.getAdjNodesButton.text")); // NOI18N
        ...
        jLabel7.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel7.text")); // NOI18N
        ...
        jLabel16.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel16.text")); // NOI18N
        ...
        jLabel17.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel17.text")); // NOI18N
        ...
        jLabel18.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel18.text")); // NOI18N
        ...
        jLabel19.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel19.text")); // NOI18N
        ...
        getAdjMatrixButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.getAdjMatrixButton.text")); // NOI18N
        ...
        isEmptyButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.isEmptyButton.text")); // NOI18N
        ...
        cleanGraphButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.cleanGraphButton.text")); // NOI18N
        ...
        existNodeButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.existNodeButton.text")); // NOI18N
        ...
        existEdgeButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.existEdgeButton.text")); // NOI18N
        ...
        jLabel8.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel8.text")); // NOI18N
        ...
        jLabel20.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel20.text")); // NOI18N
        ...
        jLabel21.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.jLabel21.text")); // NOI18N
        ...
        addEdgeButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.addEdgeButton.text")); // NOI18N
        ...
        getWeightEdgeButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.getWeightEdgeButton.text")); // NOI18N
        ...
        eraseEdgeButton.setText(org.openide.util.NbBundle.getMessage(Home_ND.class, "Home_ND.eraseEdgeButton.text")); // NOI18N
    ...
    public void adjacency_nodes(){
        ...
        ArrayList<Node> adjnodes = graph_nd.adj_nodes(node_selected_a);
        if(adjnodes.size()>0){
            String message = "\n Nodos adjacentes: \n ";
            for (Node n : adjnodes) {
                 message +=  + n.getId()+" ";
    ...
    private void erase_node(int lab_to_erase){
        ...
        for(Node n : graph_nd.g.getGraph()){
            if(n.id==lab_to_erase){
                node_to_erase = n;         
            }
        }
        graph_nd.remove_node(node_to_erase);
    ...
    private void add_edge(){
       setOpPanelGraph();
        ...
        graph_nd.add_edge(node_selected_a,node_selected_b,Integer.parseInt(weight));
    ...
    private void erase_edge(){
        ...
        if(exist_edge()){
        graph_nd.remove_edge(node_selected_a, node_selected_b);
        }else{
    ...
    private boolean exist_edge(){
        return graph_nd.exist_edge(node_selected_a, node_selected_b);
    }
    public void get_weight(){
        Node from = node_selected_a;
        Node to = node_selected_b;
        if(exist_edge()){
            int value = graph_nd.weight_edge(from,to);
    ...
    private void adjacency_matrix(){
        ...
        int[][] adj_matrix = graph_nd.adjacency_matrix();
        
        column.append("          ");
        for(Node n : graph_nd.getGraphND().getGraph()){
        ...
        int j = 0;
         ...
         for(Node n : graph_nd.getGraphND().getGraph()){
            ...
            for( j = 0 ; j<graph_nd.getGraphND().graph_size();j++){
            ...
            for(Node n : graph_nd.g.getGraph()){
                ...
                for(Edge e : n.getEdges()){
                    visitedNodes.add(n);
                        ...
                        Node ed_node = graph_nd.search_node(e.getId());
                     if(!visitedNodes.contains(ed_node)){
                        //CENTRO ORIGEN
                        ...
                        g.drawString(String.valueOf(e.weight), (p_n_center.x+punto.x)/2,(p_n_center.y+punto.y)/2);
    ...
    private void existNodeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_existNodeButtonActionPerformed
       ...
       if(graph_nd.exist_node(Integer.parseInt(id))){
    ...
    private void existEdgeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_existEdgeButtonActionPerformed
       ...
       if(graph_nd.exist_edge(graph_nd.search_node(Integer.parseInt(from)),graph_nd.search_node(Integer.parseInt(to)))){
